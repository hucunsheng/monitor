...
//    public JPanelMain(final String url, final int maxWidth, final int maxHeight) {
//        super(new BorderLayout());
//        JPanel webBrowserPanel = new JPanel(new BorderLayout());
//        final String path = "/Users/hucunsheng/Downloads/testImage/";
//        final String fileName = path+System.currentTimeMillis() + ".jpg";
...
//                        new JPanelMain("http://www.baidu.com", 640, 480),
//                        BorderLayout.CENTER);
